...
const servicesData = [
  ...
  },
  {
    ...
    skills: ["Video Editing", "Reels", "Shorts", "Adobe Premiere", "Social Media"],
  ...
  },
  {
    ...
    skills: ["SEO", "Google Search Console", "Keyword Research", "Link Building"],
